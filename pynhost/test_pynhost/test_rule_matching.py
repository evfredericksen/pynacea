...
class TestRuleMatching(unittest.TestCase):
    ...
    #     self.assertEqual(list(matching.get_rule_match(rule, words).get_words()), (['hello', 'there', 'world'], ['how', 'are', 'you']))
    ...
    #     self.assertEqual(list(matching.get_rule_match(rule, words).get_words()), ([]))
    ...
    #     self.assertEqual(list(matching.get_rule_match(rule, words).get_words()), (['hello', 'world'], ['enormous', 'universe']))
    ...
    #     self.assertEqual(list(matching.get_rule_match(rule, words).get_words()), (['range', '83'], ['through']))

    # def test_words_match_rule_num10(self):
    #     rule = ruleparser.Rule('range banana [through waffle]')
    #     words = 'range banana through'.split(' ')
    #     self.assertEqual(list(matching.get_rule_match(rule, words).get_words()), (['range', 'banana'], ['through']))
    ...
    #     self.assertEqual(list(matching.get_rule_match(rule, words).get_words()), (['yowza'], ['wowza']))
